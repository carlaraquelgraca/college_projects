...
// estas funcoes servem para pouco a nao ser que nao se tape/destape isto
...
void Consola::drawSquare(int X,int Y,int width,int Pen,int Fill)
{
	HDC DrawHDC;
	...
	Rectangle(DrawHDC,X,Y,X+width,Y+width); 
	DeleteObject(SelectObject(DrawHDC, hOPen));
